sap.ui.define(
    "assignment7/controls/MovieCard",
    [
    ...
    function (Control, Button, Image, Link, Text) {
      ...
      var MovieCard = Control.extend("assignment7.controls.MovieCard", {
        // the control API:
        metadata: {
          properties: {
            ...
            price: { type: "float" },
            currencyCode: {
              // type: "assignment7.controls.CurrencyCode",
              defaultValue: "USD",
          ...
          associations: {
            relatedBooks: {
              type: "assignment7.controls.Book",
              multiple: true,
      ...
      //overwrite setter
      assignment7.controls.MovieCard.prototype.setCoverPictureUrl = function (sVal) {
        if (sVal) {
      ...
      assignment7.controls.MovieCard.prototype.exit = function () {
